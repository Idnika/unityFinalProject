...
public class Thumb02 : MonoBehaviour
{
    ...
    void Update()
    {
        transform.localPosition = ThumbBoneSphere2R.Instance.Get_Pos();

        m_vOriginDir = (ThumbBoneSphere2R.Instance.Get_Pos() - ThumbBoneSphere3R.Instance.Get_Pos()).normalized;
