...
public class PalmTopSphere03R : MonoBehaviour
{
    ...
    //ΩÃ±€≈Ê
    private static PalmTopSphere03R m_pInstance;
    public static PalmTopSphere03R Instance
    {
        get
        {
            if (null == m_pInstance)
            {
                m_pInstance = GameObject.Find("PalmTopSphere03R").GetComponent<PalmTopSphere03R>();
            }
            return m_pInstance;
        }
    }
